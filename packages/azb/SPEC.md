...
# Shaili Specification — South Azerbaijani (azb)
**Family:** Perso-Arabic · **Status:** Draft · **Traces to:** ILM Architecture Specification (IAS)
## Abstract
This document specifies the South Azerbaijani realization of the Shaili localized programming-language family.
