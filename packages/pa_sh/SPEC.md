...
# Shaili Specification — Punjabi (Shahmukhi) (pa_sh)
**Family:** Perso-Arabic · **Status:** Draft · **Traces to:** ILM Architecture Specification (IAS)
## Abstract
This document specifies the Punjabi (Shahmukhi) realization of the Shaili localized programming-language family.
