...
# Shaili Specification — chhattisgarhi (chhattisgarhi)
**Family:** Brahmi (Devanagari) · **Status:** Draft · **Traces to:** ILM Architecture Specification (IAS)
## Abstract
This document specifies the chhattisgarhi realization of the Shaili localized programming-language family.
