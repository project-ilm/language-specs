...
# Shaili Specification — Syriac (Garshuni) (syr_gar)
**Family:** Perso-Arabic · **Status:** Draft · **Traces to:** ILM Architecture Specification (IAS)
## Abstract
This document specifies the Syriac (Garshuni) realization of the Shaili localized programming-language family.
