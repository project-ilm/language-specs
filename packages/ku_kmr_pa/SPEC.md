...
# Shaili Specification — Kurdish (Kurmanji, PA) (ku_kmr_pa)
**Family:** Perso-Arabic · **Status:** Draft · **Traces to:** ILM Architecture Specification (IAS)
## Abstract
This document specifies the Kurdish (Kurmanji, PA) realization of the Shaili localized programming-language family.
